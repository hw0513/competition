...
package com.hw.competition.web.webservice.goods.service.impl;

import com.hw.competition.service.goods.service.GoodsService;
import com.hw.competition.web.model.WebGoods;
import com.hw.competition.web.webservice.goods.mapper.WebGoodsMapper;
...
/**
 * 我这一层存在的意义在于
 *  1 competition-service是代码自动生成，我不希望改动它，方便后续重复生成
 *  2 我为了解耦而存在，您的一些个性化业务都可以在我这个层完成 因为competition-service
