package com.hw.competition.admin.common.config;
...
@MapperScan(basePackages =
        {"com.hw.competition.admin.**.mapper"
        ,"com.hw.competition.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.hw.competition.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            "com.hw.competition.admin.model," +
            "com.hw.competition.admin.rmp.model," +
            "com.hw.competition.model";//逗号分隔多个
